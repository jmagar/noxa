...
Create a `SKILL.md` file that defines what the `/quality-review` skill does. my-marketplace/plugins/quality-review-plugin/skills/quality-review/SKILL.md
...
Create a `plugin.json` file that describes the plugin. The manifest goes in the `.claude-plugin/` directory. my-marketplace/plugins/quality-review-plugin/.claude-plugin/plugin.json
...
Create the marketplace catalog that lists your plugin. my-marketplace/.claude-plugin/marketplace.json
...
- **Use external sources**: Change plugin entries to use GitHub, npm, or git URL sources instead of relative paths: ``` { "name": "my-plugin", "source": { "source": "github", "repo": "owner/repo" } } ```
...
- [strictKnownMarketplaces reference](https://code.claude.com/docs/en/settings#strictknownmarketplaces) - Managed marketplace restrictions[Claude Code Docs home page](https://code.claude.com/docs/en/overview)

[Privacy choices](https://code.claude.com/docs/en/plugin-marketplaces#)
