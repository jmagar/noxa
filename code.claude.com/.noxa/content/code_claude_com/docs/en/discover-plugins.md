...
This registers the catalog with Claude Code so you can browse what’s available. No plugins are installed yet. 2
...
This downloads the marketplace catalog and makes its plugins available to you. 2
...
Go to the **Discover** tab to see plugins from the marketplace you just added. 3
...
See [Configuration scopes](https://code.claude.com/docs/en/settings#configuration-scopes) to learn more about scopes. 4
...
- **Technical reference**: See [Plugins reference](https://code.claude.com/docs/en/plugins-reference) for complete specifications[Claude Code Docs home page](https://code.claude.com/docs/en/overview)

[Privacy choices](https://code.claude.com/docs/en/discover-plugins#)
