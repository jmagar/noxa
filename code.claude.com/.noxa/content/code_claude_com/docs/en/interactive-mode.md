...
## [​](https://code.claude.com/docs/en/interactive-mode#commands) Commands
...
## [​](https://code.claude.com/docs/en/interactive-mode#session-recap) Session recap
...
Session recap is on by default for every plan and provider. To override the `/config` toggle, set [`CLAUDE_CODE_ENABLE_AWAY_SUMMARY`](https://code.claude.com/docs/en/env-vars) to `0` or `1`. The recap is always skipped in non-interactive mode.
...
- [Memory management](https://code.claude.com/docs/en/memory) - Managing CLAUDE.md files[Claude Code Docs home page](https://code.claude.com/docs/en/overview)

[Privacy choices](https://code.claude.com/docs/en/interactive-mode#)
