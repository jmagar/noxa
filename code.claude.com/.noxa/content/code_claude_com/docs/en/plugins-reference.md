...
### [​](https://code.claude.com/docs/en/plugins-reference#monitors) Monitors
...
### [​](https://code.claude.com/docs/en/plugins-reference#plugin-list) plugin list
...
- [Settings](https://code.claude.com/docs/en/settings) - Configuration options for plugins[Claude Code Docs home page](https://code.claude.com/docs/en/overview)

[Privacy choices](https://code.claude.com/docs/en/plugins-reference#)
