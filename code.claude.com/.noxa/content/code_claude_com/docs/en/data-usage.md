...
All environment variables can be checked into `settings.json` (see [settings reference](https://code.claude.com/docs/en/settings)).[Claude Code Docs home page](https://code.claude.com/docs/en/overview)

[Privacy choices](https://code.claude.com/docs/en/data-usage#)
