...
#### [​](https://code.claude.com/docs/en/permissions#compound-commands) Compound commands
...
#### [​](https://code.claude.com/docs/en/permissions#process-wrappers) Process wrappers
...
#### [​](https://code.claude.com/docs/en/permissions#read-only-commands) Read-only commands
...
### [​](https://code.claude.com/docs/en/permissions#additional-directories-grant-file-access-not-configuration) Additional directories grant file access, not configuration
...
When sandboxing is enabled with `autoAllowBashIfSandboxed: true`, which is the default, sandboxed Bash commands run without prompting even if your permissions include `ask: Bash(*)`. The sandbox boundary substitutes for the per-command prompt. See [sandbox modes](https://code.claude.com/docs/en/sandboxing#sandbox-modes) to change this behavior.
...
## [​](https://code.claude.com/docs/en/permissions#review-auto-mode-denials) Review auto mode denials
...
- [Hooks](https://code.claude.com/docs/en/hooks-guide): automate workflows and extend permission evaluation[Claude Code Docs home page](https://code.claude.com/docs/en/overview)

[Privacy choices](https://code.claude.com/docs/en/permissions#)
