...
### [​](https://code.claude.com/docs/en/keybindings#doctor-actions) Doctor actions
...
### [​](https://code.claude.com/docs/en/keybindings#scroll-actions) Scroll actions
...
Run `/doctor` to see any keybinding warnings.[Claude Code Docs home page](https://code.claude.com/docs/en/overview)

[Privacy choices](https://code.claude.com/docs/en/keybindings#)
