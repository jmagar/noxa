...
Enter Plan Mode. Claude reads files and answers questions without making changes. claude (Plan Mode)
...
Switch back to Normal Mode and let Claude code, verifying against its plan. claude (Normal Mode)
...
Ask Claude to commit with a descriptive message and create a PR. claude (Normal Mode)
...
Have Claude list all files that need migrating (e.g., `list all 2,000 Python files that need migrating`) 2
...
- [CLAUDE.md](https://code.claude.com/docs/en/memory): store project conventions and persistent context[Claude Code Docs home page](https://code.claude.com/docs/en/overview)

[Privacy choices](https://code.claude.com/docs/en/best-practices#)
