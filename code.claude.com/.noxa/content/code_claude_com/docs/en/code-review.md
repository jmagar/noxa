...
### [​](https://code.claude.com/docs/en/code-review#rate-and-reply-to-findings) Rate and reply to findings
...
Go to [claude.ai/admin-settings/claude-code](https://claude.ai/admin-settings/claude-code) and find the Code Review section. You need admin access to your Claude organization and permission to install GitHub Apps in your GitHub organization. 2

Start setup

Click **Setup**. This begins the GitHub App installation flow. 3
...
Code Review uses read access to contents and write access to pull requests. The broader permission set also supports [GitHub Actions](https://code.claude.com/docs/en/github-actions) if you enable that later. 4

Select repositories

Choose which repositories to enable for Code Review. If you don’t see a repository, make sure you gave the Claude GitHub App access to it during installation. You can add more repositories later. 5
...
#### [​](https://code.claude.com/docs/en/code-review#what-you-can-tune) What you can tune
...
#### [​](https://code.claude.com/docs/en/code-review#example) Example
...
#### [​](https://code.claude.com/docs/en/code-review#keep-it-focused) Keep it focused
...
## [​](https://code.claude.com/docs/en/code-review#troubleshooting) Troubleshooting
...
### [​](https://code.claude.com/docs/en/code-review#retrigger-a-failed-or-timed-out-review) Retrigger a failed or timed-out review
...
### [​](https://code.claude.com/docs/en/code-review#review-didn%E2%80%99t-run-and-the-pr-shows-a-spend-cap-message) Review didn’t run and the PR shows a spend-cap message
...
### [​](https://code.claude.com/docs/en/code-review#find-issues-that-aren%E2%80%99t-showing-as-inline-comments) Find issues that aren’t showing as inline comments
...
- [Analytics](https://code.claude.com/docs/en/analytics): track Claude Code usage beyond code review[Claude Code Docs home page](https://code.claude.com/docs/en/overview)

[Privacy choices](https://code.claude.com/docs/en/code-review#)
