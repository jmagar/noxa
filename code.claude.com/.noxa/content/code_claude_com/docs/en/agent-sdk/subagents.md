...
Each subagent runs in its own fresh conversation. Intermediate tool calls and results stay inside the subagent; only its final message returns to the parent. See [What subagents inherit](https://code.claude.com/docs/en/agent-sdk/subagents#what-subagents-inherit) for exactly what’s in the subagent’s context.
...
- [SDK overview](https://code.claude.com/docs/en/agent-sdk/overview): getting started with the Claude Agent SDK[Claude Code Docs home page](https://code.claude.com/docs/en/overview)

[Privacy choices](https://code.claude.com/docs/en/agent-sdk/subagents#)
