...
The result message includes [`modelUsage`](https://code.claude.com/docs/en/agent-sdk/typescript#model-usage), a map of model name to per-model token counts and cost. This is useful when you run multiple models (for example, Haiku for subagents and Opus for the main agent) and want to see where tokens are going.
...
- [SDK Permissions](https://code.claude.com/docs/en/agent-sdk/permissions) - Managing tool permissions[Claude Code Docs home page](https://code.claude.com/docs/en/overview)

[Privacy choices](https://code.claude.com/docs/en/agent-sdk/cost-tracking#)
