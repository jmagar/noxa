...
#### [​](https://code.claude.com/docs/en/skills#live-change-detection) Live change detection
...
- **[Permissions](https://code.claude.com/docs/en/permissions)**: control tool and skill access[Claude Code Docs home page](https://code.claude.com/docs/en/overview)

[Privacy choices](https://code.claude.com/docs/en/skills#)
