...
## [​](https://code.claude.com/docs/en/fullscreen#enable-fullscreen-rendering) Enable fullscreen rendering
...
## [​](https://code.claude.com/docs/en/fullscreen#what-changes) What changes
...
## [​](https://code.claude.com/docs/en/fullscreen#use-the-mouse) Use the mouse
...
## [​](https://code.claude.com/docs/en/fullscreen#scroll-the-conversation) Scroll the conversation
...
### [​](https://code.claude.com/docs/en/fullscreen#auto-follow) Auto-follow
...
### [​](https://code.claude.com/docs/en/fullscreen#mouse-wheel-scrolling) Mouse wheel scrolling
...
## [​](https://code.claude.com/docs/en/fullscreen#search-and-review-the-conversation) Search and review the conversation
...
## [​](https://code.claude.com/docs/en/fullscreen#use-with-tmux) Use with tmux
...
## [​](https://code.claude.com/docs/en/fullscreen#keep-native-text-selection) Keep native text selection
...
## [​](https://code.claude.com/docs/en/fullscreen#research-preview) Research preview
...
To turn fullscreen rendering off, run `/tui default`, or unset the environment variable if you enabled it that way.[Claude Code Docs home page](https://code.claude.com/docs/en/overview)

[Privacy choices](https://code.claude.com/docs/en/fullscreen#)
