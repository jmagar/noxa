...
Click the **Session history** button at the top of the Claude Code panel. 2

Select the Remote tab

The dialog shows two tabs: Local and Remote. Click **Remote** to see sessions from claude.ai. 3
...
Open the [Disable Login Prompt setting](vscode://settings/claudeCode.disableLoginPrompt) and check the box. You can also open VS Code settings ( `Cmd+,` on Mac or `Ctrl+,` on Windows/Linux), search for “Claude Code login”, and check **Disable Login Prompt**. 2
...
- [Configure Claude Code settings](https://code.claude.com/docs/en/settings) to customize allowed commands, hooks, and more. These settings are shared between the extension and CLI.[Claude Code Docs home page](https://code.claude.com/docs/en/overview)

[Privacy choices](https://code.claude.com/docs/en/vs-code#)
